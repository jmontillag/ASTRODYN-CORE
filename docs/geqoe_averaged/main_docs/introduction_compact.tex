...
exponential $F = e^{if}$ that yields closed-form short-period corrections
...
equatorial singularities through Poincar\'e canonical variables, while the
critical-inclination singularity persists in all formulations retaining
the argument of perigee.  The Brouwer--Lyddane theory underlies operational
...
closed-form $J_2$ model, Lion and M\'etris~\cite{lion2013} showed that
eccentric-anomaly Hansen coefficients are finite polynomials requiring no
truncation, and Kaufman and Dasenbrock~\cite{kaufman1973} had earlier used
...
accuracy at epoch with 1--3~km/day growth.
...
corrections as closed-form rational functions of~$q$---exact in
