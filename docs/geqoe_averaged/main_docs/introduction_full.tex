...
Kozai~\cite{kozai1959} solved the same problem via an independent method,
using non-canonical Keplerian elements and the Lagrange planetary equations
to arrive at equivalent closed-form secular and periodic expressions through
...
variables with the closed-form integration relying on dedicated
trigonometric propositions.
...
complementary approach treating the case where any arbitrary spherical
harmonic---not just $J_2$---is the dominant perturbation, relevant for
lunar orbiters and irregular bodies.
...
preserve uncertainty realism far longer than Cartesian or
...
management~\cite{rivero2025,rivero2025b} demonstrates that the accuracy of the
underlying analytical propagator significantly influences the false-positive
...
GEqOE's established advantage in maintaining uncertainty
