...
closed-form rational functions of the eccentricity and inclination
parameters---exact in eccentricity, with no series truncation, and
precomputed once by symbolic algebra.
%
...
or the finite-polynomial eccentric-anomaly variants of Lion and
