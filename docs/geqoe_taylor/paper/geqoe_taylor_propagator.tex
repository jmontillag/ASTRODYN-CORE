...
\begin{itemize}
    ...
    the propagated GEqOE sensitivities, and
...
observation types (velocity, angles, line-of-sight, range, range-rate, mixed
batches), sampled path-constraint handling along the arcs, richer weighted
